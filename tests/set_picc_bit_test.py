...
def test_picc_bit_range_pass(bit, mocker):
    ...
    mocker.patch("src.py122u.nfc.Reader.get_picc_version", return_value=(144, 255))
    mocker.patch("src.py122u.nfc.Reader.set_picc_version")
    r = Reader()
...
def test_picc_bit_set_bit(old_picc, bit, value, new_picc, mocker):
    mocker.patch("src.py122u.nfc.Reader.instantiate_reader", return_value=(None, None))
    mocker.patch("src.py122u.nfc.Reader.get_picc_version", return_value=(144, old_picc))
    mock_set_picc = mocker.patch("src.py122u.nfc.Reader.set_picc_version")
    r = Reader()
